                  ...
                  <div class="relative w-48 h-48 flex justify-center items-center">
                    ...
                    <div class="absolute inset-0 -z-10 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none w-[500px] h-[500px] rounded-full overflow-hidden [mask-image:_radial-gradient(black,_transparent_60%)]">
                      <div class="h-[200%] animate-endless">
                        ...
                        <div class="absolute inset-0 [background:repeating-linear-gradient(transparent,transparent_48px,var(--color-green-500)_48px,var(--color-green-500)_49px)]"></div>
                        ...
                        <div class="absolute inset-0 [background:repeating-linear-gradient(90deg,transparent,transparent_48px,var(--color-green-500)_48px,var(--color-green-500)_49px)]"></div>
                      </div>
                    </div>
                    <!-- Icons -->
                    <transition
