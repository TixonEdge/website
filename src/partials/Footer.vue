      ...
      <div class="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
            ...
            <div class="mb-4 sm:mb-0">
              <div class="mb-4">
                ...
                <router-link class="inline-flex" to="/" aria-label="Cruip">
                  <img src="../images/logo-white.png" width="128" alt="Stellar">
                </router-link>
              </div>
              <div class="text-sm text-slate-300">&copy; tixonedge.com <span class="text-slate-500">-</span> All rights reserved.</div>
            </div>
            <!-- Social links -->
            <ul class="flex">
              <li>
                <a class="flex justify-center items-center text-green-500 hover:text-purple-400 transition duration-150 ease-in-out" href="https://x.com/TixonEdge" target="_blank" aria-label="Twitter">
              ...
              <li class="ml-2">
                <a class="flex justify-center items-center text-green-500 hover:text-purple-400 transition duration-150 ease-in-out" href="https://tixonedge.medium.com/" target="_blank"  aria-label="Dev.to">
                  ...
                  <svg class="w-12 h-12 fill-current" viewBox="0 0 24 24" style="display: block; margin: 0 auto;">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="currentColor">
                      <circle cx="6.5" cy="12" r="4.5"></circle>
                      <ellipse cx="15.5" cy="12" rx="2.5" ry="4.5"></ellipse>
                      <ellipse cx="21" cy="12" rx="1" ry="4.5"></ellipse>
                    </g>
                  </svg>
        ...
        <div class="sm:col-span-6 md:col-span-3 lg:col-span-2">
          ...
          <ul class="text-sm space-y-2">
            ...
            <li>
              <a class="text-slate-400 hover:text-slate-200 transition duration-150 ease-in-out" href="https://docs.google.com/document/d/1X7X5v3PgtLSZaV5Os984CT_8Yk6VX1SlWXxPU_ZHc1Q/edit?usp=sharing" target="_blank">Terms & Conditions</a>
            </li>
            <li>
              <a class="text-slate-400 hover:text-slate-200 transition duration-150 ease-in-out" href="https://docs.google.com/document/d/10BHQpEN9p9E5blHfcF4LSjnTk4C7y2EuMw0jRetWJzc/edit?usp=sharing" target="_blank">Privacy policy</a>
            </li>
            <li>
              <a class="text-slate-400 hover:text-slate-200 transition duration-150 ease-in-out" href="https://drive.google.com/drive/folders/153kbGKsmfxTWo8XXNLNKt2VFzgRSxcKY" target="_blank">Brand Kit</a>
            </li>
          </ul>
        </div>
