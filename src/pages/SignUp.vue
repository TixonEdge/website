      ...
      <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div class="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div class="max-w-3xl mx-auto text-center pb-12">
            ...
            <!-- Page title -->
            <h1 class="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60">Create your free account</h1>
          </div>
          ...
          <div class="max-w-sm mx-auto">
            ...
            <div class="text-center mt-4">
              <div class="text-sm text-slate-400">
                Already have an account? <router-link class="font-medium text-green-500 hover:text-purple-400 transition duration-150 ease-in-out" to="/signin">Sign in</router-link>
              </div>
            </div>
