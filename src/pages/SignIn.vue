            ...
            <div class="mb-5">
              <router-link class="inline-flex" to="/">
                <div class="relative flex items-center justify-center w-16 h-16 border border-transparent rounded-2xl shadow-2xl [background:linear-gradient(var(--color-slate-900),var(--color-slate-900))_padding-box,conic-gradient(var(--color-slate-400),var(--color-slate-700)_25%,var(--color-slate-700)_75%,var(--color-slate-400)_100%)_border-box] before:absolute before:inset-0 before:bg-slate-800/30 before:rounded-2xl">
                  <img class="relative" src="../images/logo-white.png" width="42" height="42" alt="Stellar">
                </div>
              </router-link>
            </div>
            <!-- Page title -->
            <h1 class="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60">Sign in to your account</h1>
          </div>
          ...
          <div class="max-w-sm mx-auto">
              ...
              <div class="space-y-4">
                ...
                <div>
                  <div class="flex justify-between">
                    ...
                    <router-link class="text-sm font-medium text-green-500 hover:text-purple-400 transition duration-150 ease-in-out ml-2" to="/reset-password">Forgot?</router-link>
                  </div>
                  <input id="password" class="form-input w-full" type="password" autocomplete="on" required />
                </div>
              </div>
              <div class="mt-6">
                <button class="btn text-sm text-white bg-green-500 hover:bg-purple-600 w-full shadow-xs group">
            ...
            <div class="text-center mt-4">
              <div class="text-sm text-slate-400">
                Don't have an account? <router-link class="font-medium text-green-500 hover:text-purple-400 transition duration-150 ease-in-out" to="/signup">Sign up</router-link>
              </div>
            </div>
