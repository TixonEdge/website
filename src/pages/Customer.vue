              ...
              <div class="md:grow pb-12 md:pb-20">
                <div class="max-w-3xl">
                  ...
                  <article class="pb-12 mb-12 border-b [border-image:linear-gradient(to_right,transparent,var(--color-slate-800),transparent)1]">
                    ...
                    <div class="mb-4">
                      <router-link class="inline-flex text-sm font-medium text-green-500 group" to="/customers"><span class="tracking-normal group-hover:-translate-x-0.5 transition-transform duration-150 ease-in-out mr-1">&lt;-</span> Go Back</router-link>
                    </div>
