  ...
  <section class="relative">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-16 md:pt-32">
                ...
                <div class="relative h-full bg-black rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="relative w-full h-64 md:h-auto overflow-hidden">
                      <div class="absolute bottom-0 left-1/2 -translate-x-1/2 mx-auto max-w-none md:relative md:left-0 md:translate-x-0">
                ...
                <div class="relative h-full bg-black rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col">
                    ...
                    <div class="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
                      ...
                      <div class="absolute bottom-0 left-1/2 -translate-x-1/2 mx-auto max-w-none md:max-w-full md:relative md:left-0 md:translate-x-0">
                        <Vue3Lottie :animationData="GREENJSON" :height="230" :width="230" />
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <!-- Features list -->
        <div class="grid md:grid-cols-3 gap-8 md:gap-12 hidden">
          <!-- Feature -->
          <div>
